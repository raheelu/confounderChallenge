...
subtitle: "Visualizing Confounders and Causal Inference"
format:
  html: default
...
# Add text annotations for means
ax.text(len(patients_randomized_df) * 0.95, dreamy_mean, 
        f'○ Mean = {dreamy_mean:.2f}', 
        color='#4E79A7', fontsize=11, fontweight='bold',
        verticalalignment='center', horizontalalignment='right',
        bbox=dict(boxstyle='round,pad=0.3', facecolor='white', 
                 edgecolor='#4E79A7', alpha=0.8), zorder=4)
ax.text(len(patients_randomized_df) * 0.95, duck_mean, 
        f'△ Mean = {duck_mean:.2f}', 
        color='#E15759', fontsize=11, fontweight='bold',
        verticalalignment='center', horizontalalignment='right',
        bbox=dict(boxstyle='round,pad=0.3', facecolor='white', 
...
# Calculate x position for annotations based on data range
severity_max = patients_df['severity'].max()
severity_min = patients_df['severity'].min()
x_annotation = severity_min + (severity_max - severity_min) * 0.95

# Add text annotations for means
ax.text(x_annotation, dreamy_mean, 
        f'○ Mean = {dreamy_mean:.2f}', 
        color='#4E79A7', fontsize=11, fontweight='bold',
        verticalalignment='center', horizontalalignment='right',
        bbox=dict(boxstyle='round,pad=0.3', facecolor='white', 
                 edgecolor='#4E79A7', alpha=0.8), zorder=4)
ax.text(x_annotation, duck_mean, 
        f'△ Mean = {duck_mean:.2f}', 
        color='#E15759', fontsize=11, fontweight='bold',
        verticalalignment='center', horizontalalignment='right',
        bbox=dict(boxstyle='round,pad=0.3', facecolor='white', 
